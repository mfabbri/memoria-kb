...
from .mvp_funding_package_markdown import (
    render_funding_package_index_markdown as _render_funding_package_index_markdown,
    render_go_no_go_markdown as _render_go_no_go_markdown,
)
...
def build_mvp_funding_package(
    *,
    ...
    output_checklist_md.write_text(_render_go_no_go_markdown(checklist), encoding="utf-8")
    ...
    output_index_md.write_text(_render_funding_package_index_markdown(funding_index), encoding="utf-8")
    return {
...
render_go_no_go_markdown = _render_go_no_go_markdown
render_funding_package_index_markdown = _render_funding_package_index_markdown
