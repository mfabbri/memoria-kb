...
param(
    ...
    [string]$RawRootDir = "data\raw",
    [string]$SummaryJson = "risultati\document_analysis\document_text_extraction.json"
)
...
try {
    ...
    & $pythonExe `
        -m caduti_fonti_report.document_analysis.text_extraction `
        --metadata-dir $MetadataDir `
        --output-dir $OutputDir `
        --raw-root-dir $RawRootDir `
